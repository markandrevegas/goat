...
<template>
	<footer class="text-base/7">
		<div class="grid flex-shrink-0 grid-cols-1 gap-8 p-8 py-24 sm:mx-auto sm:max-w-6xl sm:grid-cols-2 md:grid-cols-4">
			<div class="flex flex-col gap-1">
				<p class="font-display text-xl font-semibold mb-2">Floating G.O.A.T.</p>
				<p class="text-base/7">Langebrogade 1C<br />1411 København K<br />CVR: 44307987</p>
			</div>
			<div class="flex flex-col">
				<p class="font-display text-xl font-semibold mb-2">Kontakt</p>
				<p class="text-base/7">
			...
			<div class="flex flex-col">
				<p class="font-display text-xl font-semibold mb-2">Information</p>
				<ul class="list-reset">
			...
			<div class="flex flex-col">
				<p class="font-display text-xl font-semibold mb-2">Find os</p>
