...
<template>
	<div class="text-palladian relative z-10 -mt-2 h-[60vh]">
		...
		<NuxtImg src="/images/ferry-poster.webp" alt="Hero video poster" sizes="sm:100vw md:100vw lg:100vw" format="webp" quality="65" loading="lazy" fetchpriority="low" class="pointer-events-none absolute inset-0 z-0 h-full w-full object-cover hue-rotate-15" />
