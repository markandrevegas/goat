...
<template>
	<div class="relative h-screen">
		<div class="relative flex h-[calc(100vh-60px)] flex-col">
			...
			<NuxtImg src="/images/ferry-poster.webp" alt="Hero video poster" sizes="sm:100vw md:100vw lg:100vw" format="webp" quality="65" loading="eager" fetchpriority="high" class="pointer-events-none absolute inset-0 z-0 h-full w-full object-cover hue-rotate-15" />
