...
<template>
	<div class="text-palladian grid h-full w-full gap-4 px-8 sm:grid-cols-2 md:grid-cols-4">
		<div class="relative w-full">
			<WpImage loading="lazy" fetchpriority="low" :src="meetingImg" />
		...
		<div class="relative w-full">
			<WpImage loading="lazy" fetchpriority="low" :src="eventsImg" />
			<div class="absolute inset-0 z-10 flex flex-col justify-end gap-1 p-8">
		...
		<div class="relative w-full">
			<WpImage loading="lazy" fetchpriority="low" :src="workshopImg" />
			<div class="absolute inset-0 z-10 flex flex-col justify-end gap-1 p-8">
